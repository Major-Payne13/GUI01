...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Press ONCE for a surprize!";
			...
			this->textBox1->Size = System::Drawing::Size(305, 134);
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (times == 1)
			...
			textBox1->Text = textBox1->Text + "I said to press ONCE for a surprize, idiot. ";
